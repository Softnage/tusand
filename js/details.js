...
form.addEventListener("submit", function (event) {
  var numGuests = parseInt(document.getElementById("number_of_guests").value);
  ...
  if (numAdults + numChildren !== numGuests) {
    event.preventDefault();
    alert(
      "Number of adults and children must be equal to the total number of guests."
    );
